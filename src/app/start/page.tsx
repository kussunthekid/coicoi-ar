...
export default function StartPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-500 via-blue-500 to-teal-500 flex items-center justify-center p-4">
      <div className="text-center">
        ...
        <div className="space-y-8 max-w-md mx-auto">
          <button
            type="button"
            onClick={handleStart}
            className="group relative w-full px-8 py-6 bg-white/20 backdrop-blur-xl rounded-full border-2 border-white/30 transition-all duration-300 hover:scale-105 hover:bg-white/30 active:scale-95"
          >
          ...
          <button
            ...
            className="group relative w-full px-8 py-6 bg-green-500/20 backdrop-blur-xl rounded-full border-2 border-green-300/30 transition-all duration-300 hover:scale-105 hover:bg-green-500/30 active:scale-95"
          >
            <div className="flex items-center justify-center gap-4">
